    ...
    public static ArrayList createAttendees(int numberToCreate) {
        ...
        for (int i = 0; i < numberToCreate; i++) {
            group.add(new ContactImpl("John", getLastName(i),
                    "Employee (nonexempt)", "Yoyodyne Corporation"));
        }
        return group;
    }
